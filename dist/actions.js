...
exports.getUsersByTokenId = exports.login = exports.addFavPlanet = exports.addPlanet = exports.getPlanets = exports.getUsers = exports.createUser = void 0;
...
var getUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(User_1.User).find({ relations: ["planets"] })];
            case 1:
                users = _a.sent();
...
var addPlanet = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var planetRepo, newPlanet, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                planetRepo = typeorm_1.getRepository(Planet_1.Planet);
                newPlanet = planetRepo.create();
                newPlanet.name = req.body.nombrePlaneta;
                return [4 /*yield*/, planetRepo.save(newPlanet)];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                token = jsonwebtoken_1["default"].sign({ user: user }, process.env.JWT_KEY, { expiresIn: "24h" });
...
exports.login = login;
var getUsersByTokenId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(req.userId);
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).findOne(req.userId)];
            case 1:
                users = _a.sent();
                return [2 /*return*/, res.json(users)];
        }
...
exports.getUsersByTokenId = getUsersByTokenId;
